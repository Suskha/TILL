...
#### The following day I stated Testing course:
...
* Test-driven development (TDD) is a software development process that relies on the repetition of a very short development cycle:
	...
	2. then produces the minimum amount of code to pass that test, and finally refactors the new code to acceptable standards
	
* Following sequence of steps are generally followed :
	1. Add a test
